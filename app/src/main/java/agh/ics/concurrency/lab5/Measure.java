...
import agh.ics.concurrency.lab5.NestedLocks;
import agh.ics.concurrency.lab4.CorrectRandomProduceConsume;
import agh.ics.concurrency.lab3.RandomProduceConsume;
...
public class Measure {
    ...
    public void run4condition(int producersCount, int consumersCount, int bufferMax) {
        ...
        System.out.println("Measure 4 Condition:");
        for (int k = 0; k < 30; k++) {
            System.out.print(k + ". ");
    ...
    public void run2condition(int producersCount, int consumersCount, int bufferMax) {
            RandomProduceConsume pc = new RandomProduceConsume(bufferMax);
            ...
            System.out.println("Measure 2 Condition:");
            for (int k = 0; k < 30; k++) {
                System.out.print(k + ". ");
                for (int i = 0; i < producersCount; i++)
                    System.out.print("+" + produceAmounts[i] + ": " + produceLog[i] + "  ");
    ...
    public void runNestedLocks(int producersCount, int consumersCount, int bufferMax) {
        ...
        System.out.println("Measure nested locks:");
        for (int k = 0; k < 30; k++) {
            System.out.print(k + ". ");
            for (int i = 0; i < producersCount; i++)
                System.out.print("+" + produceAmounts[i] + ": " + produceLog[i] + "  ");
